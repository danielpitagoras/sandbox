...
@Table(name = "filme")
@NamedQuery(
		name = "consultaFilmePorChavePrimaria",
...
@NamedQueries({
		...
		@NamedQuery(
				...
				query = "select f from Filme f join f.categoria c where c.categoria = :categoria"
)})
...
/**
	 * 
	 */
	private static final long serialVersionUID = -5824350056835308672L;
